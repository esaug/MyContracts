...
contract Oubita is ERC721, Ownable {
   ...
   //uint256 public NFTperAddressLimit= 20;
    ...
    )ERC721("UOBITA COLLECTION","UOBITA") payable {
        contrato = address(this);
        ownerContract = msg.sender;
        setBaseURI(_initBaseURI);
        tokenContract = _tokenContract;

    // Invocacion transferToken
    }
        ...
        if(msg.sender != owner()){
            ...
            if(onlyWhitelisted == true){
                  ...
                  //  require(ownerMintedCount + _mintAmount <= NFTperAddressLimit, "max NFT per address exceeded");
                    ...
                    multiTokensTransfer(paidmentAddress, tipo, _mintAmount, counter);
    ...
    function setNftPrice(uint _amount)public returns(uint _cost){   
        return cost = _amount;
    }
